...
| Special-semantics disposition | The bounded code set is classified with original-source evidence and minimum Tokimu ownership in [`E1M1 special semantics evidence`](../../../../docs/Plans/DOOM/Evidence/E1M1%20special%20semantics%20evidence.md). All remain unsupported observations until their listed runtime/application/presentation boundaries exist. |
