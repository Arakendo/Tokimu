...
The native overview intentionally does not claim original Doom plane-span
rendering, visibility, gameplay, sky rendering, masked-middle rendering, or
general alpha blending. Those omissions remain retained Slice 5B evidence.
