use tokimu::openxr::{create_openxr_session_from_readiness, OpenXrHeadsetProofPlan};

fn main() {
    let readiness =
        OpenXrHeadsetProofPlan::quest_pro_via_steamvr("Tokimu Hello 3D OpenXR").readiness();
