...
[`webgpu-wasm-quick-reference.md`
...
wasm-bindgen target/wasm32-unknown-unknown/release/hello-alpha-policy-web.wasm --target web --out-dir corpus/campaigns/textured-presentation/hello-alpha-policy-web/web/pkg --out-name hello-alpha-policy-web
python -m http.server 4178 --directory corpus/campaigns/textured-presentation/hello-alpha-policy-web/web
```
