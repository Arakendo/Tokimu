...
wasm-bindgen target/wasm32-unknown-unknown/debug/hello-textured-box-web.wasm --out-dir corpus/campaigns/textured-presentation/hello-textured-box-web/web/pkg --target web
```
