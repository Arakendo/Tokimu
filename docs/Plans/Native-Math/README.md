# Native Math Campaign

| Field | Value |
| --- | --- |
| Status | Parked |
| Controlling plan | [Native Math Vocabulary And Foreign-Type Case Study](native-math-vocabulary-foreign-type-case-study.md) |
| Controlling review | AR-0019 |
| Current disposition | Retain Alternative A; keep B and C as corpus-local incubation evidence |
| Next action | Reopen after independent CAD, AR-0026, provider-update, or operation-growth pressure |
...
corpus under `corpus/lib/tokimu-math-study/`.
