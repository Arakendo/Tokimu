...
| Recorded | 2026-08-10 |
| Plan | `docs/Plans/Coordinate-Conformance/coordinate-frame-directional-conformance.md` |
| Review | AR-0028 |
...
- `corpus/campaigns/textured-presentation/hello-textured-box/src/main.rs`
...
- `docs/Plans/DOOM/Evidence/Classic Doom wall V placement evidence.md`
