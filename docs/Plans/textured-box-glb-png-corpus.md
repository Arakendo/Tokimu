...
- the pinned Khronos `Models/Box/glTF-Binary/Box.glb` fixture, decoded by
  `corpus/hello-glb` into Tokimu-owned positions and normals; and
...
- [x] Record the exact Box fixture path, source revision/vendor state,
  ...
  in [`corpus/hello-textured-box/fixture-manifest.md`](../../corpus/hello-textured-box/fixture-manifest.md).
...
- [x] Name the future `hello-textured-box` corpus consumer and retain its
  boundary/design assertions in [`corpus/hello-textured-box/DESIGN.md`](../../corpus/hello-textured-box/DESIGN.md).
...
- [Hello GLB Design](../../corpus/hello-glb/DESIGN.md)
