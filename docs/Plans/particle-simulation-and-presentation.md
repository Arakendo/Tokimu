...
proved by a focused `corpus/hello-particles` application before the Asteroids
consumer adopts it.
...
- [x] Create `corpus/hello-particles` with a focused `DESIGN.md`.
...
- [`hello-asteroids`](../../corpus/hello-asteroids/DESIGN.md)
