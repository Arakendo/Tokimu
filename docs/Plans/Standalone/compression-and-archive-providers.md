...
- `corpus/focused/data-interchange/hello-compression` now exercises all three codecs and goals through
...
- `corpus/focused/data-interchange/hello-archive` consumes an immutable first-party ZIP fixture solely
