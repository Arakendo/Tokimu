...
`corpus/focused/audio/hello-milkdrop/EXTERNAL-PRESET-ADMISSION.md` provides the required
...
- [x] Create `corpus/focused/audio/hello-audio-visualizer` with one fullscreen render pass.
