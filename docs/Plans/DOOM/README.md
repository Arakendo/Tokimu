...
Ordinary Doom-provider findings stay in this campaign. Questions that change a
generic Tokimu contract, ownership boundary, or accepted ADR return to the
relevant Architectural Review before implementation widens.
