...
`corpus/hello-hole-punch` evidence. The source exposes five named translation
...
`corpus/hello-runtime-observation` now exercises the first read-only boundary:
...
- `corpus/hello-hole-punch/DESIGN.md`
