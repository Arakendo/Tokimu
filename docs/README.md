...
- [ADR-0016: Single-Bit Stencil Mask Pipeline State](ADR/ADR-0016-single-bit-stencil-mask-pipeline-state.md)
- [ADR-0017: Observable Terminal Failure and Host-Crash Conformance](ADR/ADR-0017-observable-terminal-failure-and-host-crash-conformance.md)
