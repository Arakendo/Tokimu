/* @ts-self-types="./tokimu_asset_workbench_engine.d.ts" */
...
export class PresentationSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PresentationSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_presentationsession_free(ptr, 0);
    }
    /**
     ...
     * @returns {string}
     */
    clear_override(request_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.presentationsession_clear_override(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    constructor(observation_json) {
        const ptr0 = passStringToWasm0(observation_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.presentationsession_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        PresentationSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {string}
     */
    set_override(request_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(request_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.presentationsession_set_override(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    targets() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.presentationsession_targets(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function inspect_asset(file_name, bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.inspect_asset(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./tokimu_asset_workbench_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tokimu_asset_workbench_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
